...
#[utoipa::path(
    ...
    responses(
        (status = 200, description = "Blog Content, using the BlogContent schema", body = [crate::swagger_docs::_BlogContent])
    )
)]
...
#[utoipa::path(
    ...
    responses(
        (status = 200, description = "Blog Preview, using the BlogPreview schema", body = [crate::swagger_docs::_BlogContent])
    )
)]
...
#[utoipa::path(
    ...
    responses(
        (status = 200, description = "Experience of what I hafve done for work, using the TypeExp schema", body = [crate::swagger_docs::_TypeExp])
    )
)]
...
#[utoipa::path(
    ...
    responses(
        (status = 200, description = "Project info, using the ProjectDes schema", body = [crate::swagger_docs::_ProjectDes])
    )
)]
